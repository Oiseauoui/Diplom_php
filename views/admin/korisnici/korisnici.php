...
<?php foreach ($this->korisnici as $korisnik) { ?>
        ...
        echo "Неактивен";
            ...
            <td>
                <a href="<?php echo ADMIN_URL . 'korisnici/izmeni/' . $korisnik['user_id'] ?>"> Изменить</a>

            </td>
            <td>
                <a href="<?php echo ADMIN_URL . 'korisnici/obrisiKorisnika/' . $korisnik['user_id'] ?>"
                   title="Obrisi korisnika" onclick="return confirm('Вы уверены, что хотите удалить?');" > <img src="<?php echo URL . 'images/delete.png' ?>" /></a>
            </td>
        </tr>
    <?php } ?>
</table>
