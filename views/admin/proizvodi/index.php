...
?>
    ...
    <div class='search'>
        <form action='<?php echo $this->paginationUrl?>' method='get'>
            ...
            <a class="button" href="<?php echo ADMIN_URL . 'proizvodi/noviProizvod'; ?>" >Добавить новый товар</a>
    ...
    <?php
        ...
        foreach ($this->items as $item) {
            ...
            echo '<tr>';
            echo '<td><a href="' . ADMIN_URL . 'proizvodi/azuriranjeProizvoda/' . $item['item_id'] . '" title="Изменить">' . $item['item_id'] . '</td>';
        ...
        foreach ($this->podkategorije as $subCategory){
            ...
            echo '<td><a href="' . ADMIN_URL .'proizvodi/obrisiProizvod?item_id=' . $item['item_id'] . '" title="Удалить товар" class="obrisi" onclick="return confirm(\'Вы уверены, что хотите удалить?\');"  ><img src="' . URL . 'images/delete.png" /></a></td>';
