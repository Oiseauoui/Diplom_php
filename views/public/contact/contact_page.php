        ...
        <div class='row'> 
            <div class='col-xs-12 col-sm-5'>
                <div class='kontakt-forma'>        
                    ...
                    if (!empty($_GET['poruka']) && $_GET['poruka'] == 'didnotsent') {
                        echo '<p style="color:#e6005c; font-weight:bold;">Сообщение не было отправлено, пожалуйста, попробуйте еще раз!</p>';
                    }
                    ?>  
                    <form class="form contact_form" action="<?php echo URL . 'contact/poruka'; ?>" method="post" >
