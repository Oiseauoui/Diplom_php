        ...
        <div class='row'>
            <div class='col-sm-6 col-sm-offset-3'>
                <div class='logInForm'>
                    ...
                    <form action="<?php echo URL . 'korisnici/ulogujSe'; ?>" method="post" id="login_form" >
                    ...
                    <p class='loginP'>Если у Вас нет аккаунта, пожалуйста <a class='link-reg' href="<?php echo URL . 'korisnici/registracija ' ?>">  ЗАРЕГИСТРИРУЙТЕСЬ.</a></p>
                </div>
            </div>
        </div>
    </div>
